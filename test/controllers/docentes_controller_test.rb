...
class DocentesControllerTest < ActionController::TestCase
  ...
  test "should create docente" do
    assert_difference('Docente.count') do
      post :create, docente: { Sueldo: @docente.Sueldo, Universidad: @docente.Universidad, nombre: @docente.nombre }
    end
  ...
  test "should update docente" do
    patch :update, id: @docente, docente: { Sueldo: @docente.Sueldo, Universidad: @docente.Universidad, nombre: @docente.nombre }
    assert_redirected_to docente_path(assigns(:docente))
  end
